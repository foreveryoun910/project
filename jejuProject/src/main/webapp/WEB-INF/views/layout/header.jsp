					...
					<li>
						<div class="cart dropdown">
							...
							<div class="dropdown-menu dropup">
								...
								<ul class="media-list">
									<li class="media"><img class="pull-left"
										src="<%=request.getContextPath()%>/resource/images/product-item.jpg"
										alt="">
										<div class="media-body">
											<h6>
												Italian Sauce <span>$250</span>
											</h6>
										</div></li>
								</ul>
					...
					<form action="#" method="post" id="create-account_form" class="std">
						<fieldset>
							...
							<div class="form_content clearfix">
								...
								<p class="text">
									<label for="email_create">E-mail address</label> <span>
