		...
		<form id="frm" name="frm" action="infoUpdate.do" method="post">
				...
				<table border="1" style="border-collapse: collapse;">
					<tr>
						...
						<td width="100">
							<select id="iSubject" name="iSubject">
								<option selected>${info.iSubject}</option>
						...
						<td width="70" align="center">${info.iNo}<input type="hidden" id="iNo" name="iNo" value="${info.iNo}"></td>
						<th width="100">작성자</th>
					...
					<tr>
						...
						<td colspan="7"><input type="text" id="iTitle" name="iTitle" size="106" required="required" value="${info.iTitle}"></td>
					</tr>
					<tr>
						<th width="100">글 내용</th>
						<td colspan="7"><textarea rows="7" cols="110" id="iContent" name="iContent" required="required">${info.iContent}</textarea></td>
					</tr>
				</table>
				</div><br>
				<div>
